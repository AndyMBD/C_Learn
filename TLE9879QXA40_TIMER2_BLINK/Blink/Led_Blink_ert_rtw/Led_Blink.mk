###########################################################################
## Makefile generated for component 'Led_Blink'. 
## 
## Makefile     : Led_Blink.mk
## Generated on : Wed Jun 01 20:55:01 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Led_Blink.exe
...
START_DIR                 = D:\TLE9879\Project\TLE9879QXA40_TIMER2_BLINK
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Led_Blink_comp.rsp
CMD_FILE                  = Led_Blink.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Led_Blink.exe
...
DEFINES_STANDARD = -DMODEL=Led_Blink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Led_Blink_ert_rtw\Led_Blink.c
...
{$(START_DIR)\Led_Blink_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Led_Blink_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Led_Blink.obj : $(START_DIR)\Led_Blink_ert_rtw\Led_Blink.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Led_Blink_ert_rtw\Led_Blink.c
